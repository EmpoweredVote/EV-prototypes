...
function App() {
  ...
  const baseCategories = searchQuery ? filteredCategories : currentCategories;
  const hasActualData = isPastYear && baseCategories.some(c => (c.actualAmount ?? 0) > 0);
  const displayCategories = baseCategories.filter(c =>
